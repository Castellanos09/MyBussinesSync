...
fun EditServicioView(navController: NavController, serviciosVM: ServiciosViewModel, idDoc: String) {

    LaunchedEffect(Unit) {
        serviciosVM.getServiceById(idDoc);
    }

    val state = serviciosVM.state
    ...
    Scaffold (
        ...
        Column(modifier = Modifier
            ...
            OutlinedTextField(
                value =  state.cliente,
                onValueChange = {serviciosVM.onValue(it, "cliente")},
...
//INGRESAR UNA DESCRIPCIÓN
            OutlinedTextField(
                value = state.numero,
                onValueChange = {serviciosVM.onValue(it, "numero")},
            ...
            OutlinedTextField(
                ...
                onValueChange = {serviciosVM.onValue(it, "vehiculo")},
            ...
            OutlinedTextField(
                value = state.color,
                onValueChange = {serviciosVM.onValue(it, "color")},
            ...
            OutlinedTextField(
                ...
                onValueChange = {serviciosVM.onValue(it, "servicio")},
            ...
            //EDITAR SERVICIO
            Button(onClick = {
                serviciosVM.updateService(idDoc){
